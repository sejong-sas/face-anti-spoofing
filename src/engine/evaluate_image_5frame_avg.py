...
CSV_PATH = ROOT / "metadata" / "frames_5frame.csv"
CHECKPOINT_PATH = ROOT / "outputs" / "checkpoints" / "image_baseline_1frame_resnet18.pth"

PRED_CSV_PATH = ROOT / "outputs" / "predictions" / "image_baseline_5frame_test_predictions.csv"
VIDEO_PRED_CSV_PATH = ROOT / "outputs" / "predictions" / "image_baseline_5frame_test_video_predictions.csv"
METRIC_CSV_PATH = ROOT / "outputs" / "metrics" / "image_baseline_5frame_test_metrics.csv"
CM_FIG_PATH = ROOT / "outputs" / "figures" / "image_baseline_5frame_confusion_matrix.png"
