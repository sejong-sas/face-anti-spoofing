...
PRED_CSV_PATH = ROOT / "outputs" / "predictions" / "image_baseline_1frame_test_predictions.csv"
VIDEO_PRED_CSV_PATH = ROOT / "outputs" / "predictions" / "image_baseline_1frame_test_video_predictions.csv"
METRIC_CSV_PATH = ROOT / "outputs" / "metrics" / "image_baseline_1frame_test_metrics.csv"
CM_FIG_PATH = ROOT / "outputs" / "figures" / "image_baseline_1frame_confusion_matrix.png"
...
def main():
    ...
    print(f"[INFO] test face frames: {len(test_df)}")
    ...
    print(f"[INFO] saved image-level predictions -> {PRED_CSV_PATH}")
